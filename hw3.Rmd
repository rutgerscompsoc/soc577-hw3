...
Q.14. Complete the `stm` function to run an initial topic modeling. Pick a value for `K` and add arguments to allow prevalence to vary as a function of month (either linear or non-linear) and party, and content to vary as a function of party.
